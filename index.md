...
<section class="grid-recursos">
    <a href="/arquivos/norma-fab.pdf" class="card-download" target="_blank">
        <strong style="color: #0f4c5c;">Normativa FAB: ICA 65-36</strong>
        <span>Baixar PDF</span>
    </a>
    <a href="/arquivos/norma-eb.pdf" class="card-download" target="_blank">
        <strong style="color: #0f4c5c;">Normativa EB: EB30-N-40.105</strong>
        <span>Baixar PDF</span>
    </a>
    <a href="/arquivos/norma-mb.pdf" class="card-download" target="_blank">
        <strong style="color: #0f4c5c;">Normativa MB: DGMM-3009</strong>
        <span>Baixar PDF</span>
    </a>
</section>
...
<section id="contacto">
    <div class="contact-box">
        <h1 class="main-title" style="font-size: 2.2rem; margin-bottom: 1.5rem;">Contato</h1>
